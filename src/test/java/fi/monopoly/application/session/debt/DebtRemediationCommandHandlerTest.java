    ...
    private DebtRemediationCommandHandler newHandler(
        ...
        return new DebtRemediationCommandHandler(
                ...
                () -> new SessionState(
                        ...
                        List.of(new SeatState("seat-0", 0, playerId(debtor), SeatKind.HUMAN, ControlMode.MANUAL, debtor.getName(), "HUMAN", "#000000")),
                        List.of(new PlayerSnapshot(playerId(debtor), "seat-0", debtor.getName(), debtor.getMoneyAmount(), -1, false, false, false, 0, 0, List.of())),
                        List.of(),

...
public record LayoutMetrics(
    ...
    public static int spacingXl() {
        return SPACING_XL;
    }

    public static int sidebarLabelX() {
        return SIDEBAR_LABEL_X;
    }

    public static int sidebarValueX() {
        return SIDEBAR_VALUE_X;
    }

    public static int sidebarMinContentTop() {
        return SIDEBAR_MIN_CONTENT_TOP;
    }

    public static int sidebarHistoryPreferredHeight() {
        return SIDEBAR_HISTORY_PREFERRED_HEIGHT;
    }

    public static int sidebarHistoryMinHeight() {
        return SIDEBAR_HISTORY_MIN_HEIGHT;
    }

    public static int sidebarHistoryHeaderHeight() {
        return SIDEBAR_HISTORY_HEADER_HEIGHT;
    }

    public static int sidebarHistoryTextInset() {
        return SIDEBAR_HISTORY_TEXT_INSET;
    }

    public static int sidebarHistoryTopMargin() {
        return SIDEBAR_HISTORY_TOP_MARGIN;
    }

    public static int sidebarLineHeight() {
        return SIDEBAR_LINE_HEIGHT;
    }
    ...
    public static int overlayPrimaryButtonY() {
        return OVERLAY_PRIMARY_BUTTON_Y;
    }

    public static int overlaySecondaryRow1Y() {
        return OVERLAY_SECONDARY_ROW_1_Y;
    }

    public static int overlaySecondaryRow2Y() {
        return OVERLAY_SECONDARY_ROW_2_Y;
    }

    public static int overlaySecondaryRow3Y() {
        return OVERLAY_SECONDARY_ROW_3_Y;
    }

    public static int popupDefaultWidth() {
        return POPUP_DEFAULT_WIDTH;
    }

    public static int popupDefaultHeight() {
        return POPUP_DEFAULT_HEIGHT;
    }

    public static int popupMinWidth() {
        return POPUP_MIN_WIDTH;
    }

    public static int popupMinHeight() {
        return POPUP_MIN_HEIGHT;
    }

    public static int popupWindowMargin() {
        return POPUP_WINDOW_MARGIN;
    }

    public static int popupTextTopOffset() {
        return POPUP_TEXT_TOP_OFFSET;
    }

    public static int popupTextSidePadding() {
        return POPUP_TEXT_SIDE_PADDING;
    }

    public static int popupTextBottomPadding() {
        return POPUP_TEXT_BOTTOM_PADDING;
    }

    public static int popupTextLineHeight() {
        return POPUP_TEXT_LINE_HEIGHT;
    }

    public static int popupButtonAreaTopPadding() {
        return POPUP_BUTTON_AREA_TOP_PADDING;
    }

    public static int popupButtonAreaBottomPadding() {
        return POPUP_BUTTON_AREA_BOTTOM_PADDING;
    }

    public static int popupButtonMinWidth() {
        return POPUP_BUTTON_MIN_WIDTH;
    }

    public static int popupButtonMaxWidth() {
        return POPUP_BUTTON_MAX_WIDTH;
    }

    public static int popupButtonHeight() {
        return POPUP_BUTTON_HEIGHT;
    }

    public static int popupButtonPadding() {
        return POPUP_BUTTON_PADDING;
    }

    public static int popupButtonGapX() {
        return POPUP_BUTTON_GAP_X;
    }

    public static int popupButtonGapY() {
        return POPUP_BUTTON_GAP_Y;
    }

    public static int popupCloseButtonSize() {
        return POPUP_CLOSE_BUTTON_SIZE;
    }

    public static int popupCloseButtonRightInset() {
        return POPUP_CLOSE_BUTTON_RIGHT_INSET;
    }
    ...
    public static int tradePopupPreferredWidth() {
        return TRADE_POPUP_PREFERRED_WIDTH;
    }

    public static int tradePopupPreferredHeight() {
        return TRADE_POPUP_PREFERRED_HEIGHT;
    }

    public static int tradePopupMinWidth() {
        return TRADE_POPUP_MIN_WIDTH;
    }

    public static int tradePopupMinHeight() {
        return TRADE_POPUP_MIN_HEIGHT;
    }

    public static float tradePopupTopMargin() {
        return TRADE_POPUP_TOP_MARGIN;
    }

    public static float tradePanelsTopOffset() {
        return TRADE_PANELS_TOP_OFFSET;
    }

    public static float tradePanelsHeight() {
        return TRADE_PANELS_HEIGHT;
    }

    public static float tradePanelGap() {
        return TRADE_PANEL_GAP;
    }

    public static float tradePanelPadding() {
        return TRADE_PANEL_PADDING;
    }

    public static float tradePanelHeaderHeight() {
        return TRADE_PANEL_HEADER_HEIGHT;
    }

    public static float tradeItemGap() {
        return TRADE_ITEM_GAP;
    }

    public static float tradeInventoryTopGap() {
        return TRADE_INVENTORY_TOP_GAP;
    }

    public static float tradeInventoryTitleGap() {
        return TRADE_INVENTORY_TITLE_GAP;
    }

    public static float tradeTokenSize() {
        return TRADE_TOKEN_SIZE;
    }

    public static float tradeSubtitleTopOffset() {
        return TRADE_SUBTITLE_TOP_OFFSET;
    }

    public static float tradeFooterBottomPadding() {
        return TRADE_FOOTER_BOTTOM_PADDING;
    }

    public static float tradePropertyColorStripeHeight() {
        return TRADE_PROPERTY_COLOR_STRIPE_HEIGHT;
    }

    public static float tradeButtonAreaBottomMargin() {
        return TRADE_BUTTON_AREA_BOTTOM_MARGIN;
    }

    public static float tradeButtonAreaTopMargin() {
        return TRADE_BUTTON_AREA_TOP_MARGIN;
    }

    public static float tradeCardRadius() {
        return TRADE_CARD_RADIUS;
    }

    public static float tradeCardInnerRadius() {
        return TRADE_CARD_INNER_RADIUS;
    }

    public static int tradeCardInset() {
        return TRADE_CARD_INSET;
    }

    public static int tradeBackButtonWidth() {
        return TRADE_BACK_BUTTON_WIDTH;
    }

    public static int tradeBackButtonHeight() {
        return TRADE_BACK_BUTTON_HEIGHT;
    }

    public static int tradeBackButtonLeftInset() {
        return TRADE_BACK_BUTTON_LEFT_INSET;
    }

    public static int tradeBackButtonTopInset() {
        return TRADE_BACK_BUTTON_TOP_INSET;
    }
    ...
    public float debtSectionTitleY() {
        return sidebarPrimaryButtonY() + (usesCompactSidebarHeight() ? 48 : 48);
    }

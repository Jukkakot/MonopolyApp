...
import static fi.monopoly.utils.MonopolyUtils.isMouseInArea;
...
public class SpotImage extends Image {
    ...
    public SpotImage(Coordinates coords, SpotType spotType) {
        super(coords, null, StreetType.CORNER.equals(spotType.streetType) ? Spot.SPOT_H : Spot.SPOT_W, Spot.SPOT_H);
    ...
    private void updateIsHovered() {
        isHovered = MonopolyUtils.isMouseInArea(new SpotProps(coords, getUnScaledWidth(), getUnScaledHeight()));
    }

...
public enum StreetType {
    ...
    LIGHT_BLUE(PlaceType.STREET, MonopolyUtils.toColor(170, 224, 250)),
    PURPLE(PlaceType.STREET, MonopolyUtils.toColor(218, 59, 151)),
    ORANGE(PlaceType.STREET, MonopolyUtils.toColor(247, 148, 29)),

 ...
 * notices are useful desktop behaviors, but they are not part of the transport-neutral
 * {@code ClientSession} state/view subscription API that a remote backend client should depend on.
 */
